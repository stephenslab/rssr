...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::ArrayXd& >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< const Eigen::ArrayXd& >::type mu(muSEXP);
    Rcpp::traits::input_parameter< const Eigen::ArrayXd& >::type SiRiSr(SiRiSrSEXP);
...
RcppExport SEXP rssr_wrap_rss_varbvsr_iter(SEXP SiRiSSEXP, SEXP sigma_betaSEXP, SEXP logoddsSEXP, SEXP betahatSEXP, SEXP seSEXP, SEXP alphaSEXP, SEXP muSEXP, SEXP SiRiSrSEXP, SEXP reverseSEXP) {
    ...
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(rssr_wrap_rss_varbvsr_iter_try(SiRiSSEXP, sigma_betaSEXP, logoddsSEXP, betahatSEXP, seSEXP, alphaSEXP, muSEXP, SiRiSrSEXP, reverseSEXP));
    }
...
// rss_varbvsr_squarem
Rcpp::List rss_varbvsr_squarem(const Eigen::MappedSparseMatrix<double>& SiRiS, const double sigma_beta, const double logodds, const Eigen::Map<Eigen::ArrayXd> betahat, const Eigen::Map<Eigen::ArrayXd> se, const Eigen::ArrayXd& talpha0, const Eigen::ArrayXd& tmu0, const Eigen::ArrayXd& tSiRiSr0, double tolerance, int itermax, Rcpp::LogicalVector verbose, Rcpp::LogicalVector lnz_tol);
static SEXP rssr_rss_varbvsr_squarem_try(SEXP SiRiSSEXP, SEXP sigma_betaSEXP, SEXP logoddsSEXP, SEXP betahatSEXP, SEXP seSEXP, SEXP talpha0SEXP, SEXP tmu0SEXP, SEXP tSiRiSr0SEXP, SEXP toleranceSEXP, SEXP itermaxSEXP, SEXP verboseSEXP, SEXP lnz_tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const Eigen::MappedSparseMatrix<double>& >::type SiRiS(SiRiSSEXP);
    Rcpp::traits::input_parameter< const double >::type sigma_beta(sigma_betaSEXP);
...
RcppExport SEXP rssr_rss_varbvsr_squarem(SEXP SiRiSSEXP, SEXP sigma_betaSEXP, SEXP logoddsSEXP, SEXP betahatSEXP, SEXP seSEXP, SEXP talpha0SEXP, SEXP tmu0SEXP, SEXP tSiRiSr0SEXP, SEXP toleranceSEXP, SEXP itermaxSEXP, SEXP verboseSEXP, SEXP lnz_tolSEXP) {
    ...
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(rssr_rss_varbvsr_squarem_try(SiRiSSEXP, sigma_betaSEXP, logoddsSEXP, betahatSEXP, seSEXP, talpha0SEXP, tmu0SEXP, tSiRiSr0SEXP, toleranceSEXP, itermaxSEXP, verboseSEXP, lnz_tolSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
Rcpp::List rss_varbvsr_squarem_fit_logodds(const Eigen::MappedSparseMatrix<double>& SiRiS, const double sigma_beta, const double logodds0, const Eigen::Map<Eigen::ArrayXd> betahat, const Eigen::Map<Eigen::ArrayXd> se, const Eigen::ArrayXd& talpha0, const Eigen::ArrayXd& tmu0, const Eigen::ArrayXd& tSiRiSr0, double tolerance, int itermax, Rcpp::LogicalVector verbose, Rcpp::LogicalVector lnz_tol);
static SEXP rssr_rss_varbvsr_squarem_fit_logodds_try(SEXP SiRiSSEXP, SEXP sigma_betaSEXP, SEXP logodds0SEXP, SEXP betahatSEXP, SEXP seSEXP, SEXP talpha0SEXP, SEXP tmu0SEXP, SEXP tSiRiSr0SEXP, SEXP toleranceSEXP, SEXP itermaxSEXP, SEXP verboseSEXP, SEXP lnz_tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const Eigen::MappedSparseMatrix<double>& >::type SiRiS(SiRiSSEXP);
    Rcpp::traits::input_parameter< const double >::type sigma_beta(sigma_betaSEXP);
...
RcppExport SEXP rssr_rss_varbvsr_squarem_fit_logodds(SEXP SiRiSSEXP, SEXP sigma_betaSEXP, SEXP logodds0SEXP, SEXP betahatSEXP, SEXP seSEXP, SEXP talpha0SEXP, SEXP tmu0SEXP, SEXP tSiRiSr0SEXP, SEXP toleranceSEXP, SEXP itermaxSEXP, SEXP verboseSEXP, SEXP lnz_tolSEXP) {
    ...
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(rssr_rss_varbvsr_squarem_fit_logodds_try(SiRiSSEXP, sigma_betaSEXP, logodds0SEXP, betahatSEXP, seSEXP, talpha0SEXP, tmu0SEXP, tSiRiSr0SEXP, toleranceSEXP, itermaxSEXP, verboseSEXP, lnz_tolSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static SEXP rssr_rss_varbvsr_naive_try(SEXP SiRiSSEXP, SEXP sigma_betaSEXP, SEXP logoddsSEXP, SEXP betahatSEXP, SEXP seSEXP, SEXP talpha0SEXP, SEXP tmu0SEXP, SEXP tSiRiSr0SEXP, SEXP toleranceSEXP, SEXP itermaxSEXP, SEXP verboseSEXP, SEXP lnz_tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const Eigen::MappedSparseMatrix<double>& >::type SiRiS(SiRiSSEXP);
    Rcpp::traits::input_parameter< const double >::type sigma_beta(sigma_betaSEXP);
...
RcppExport SEXP rssr_rss_varbvsr_naive(SEXP SiRiSSEXP, SEXP sigma_betaSEXP, SEXP logoddsSEXP, SEXP betahatSEXP, SEXP seSEXP, SEXP talpha0SEXP, SEXP tmu0SEXP, SEXP tSiRiSr0SEXP, SEXP toleranceSEXP, SEXP itermaxSEXP, SEXP verboseSEXP, SEXP lnz_tolSEXP) {
    ...
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(rssr_rss_varbvsr_naive_try(SiRiSSEXP, sigma_betaSEXP, logoddsSEXP, betahatSEXP, seSEXP, talpha0SEXP, tmu0SEXP, tSiRiSr0SEXP, toleranceSEXP, itermaxSEXP, verboseSEXP, lnz_tolSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int rssr_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("Rcpp::List(*rss_varbvsr_naive)(const Eigen::MappedSparseMatrix<double>&,const double,const double,const Eigen::Map<Eigen::ArrayXd>,const Eigen::Map<Eigen::ArrayXd>,const Eigen::ArrayXd&,const Eigen::ArrayXd&,const Eigen::ArrayXd&,double,int,Rcpp::LogicalVector,Rcpp::LogicalVector)");
    }
...
RcppExport SEXP rssr_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("rssr", "rssr_rss_varbvsr_naive", (DL_FUNC)rssr_rss_varbvsr_naive_try);
    R_RegisterCCallable("rssr", "rssr_RcppExport_validate", (DL_FUNC)rssr_RcppExport_validate);
    return R_NilValue;
}
