...
Rcpp::DataFrame grid_search_rss_varbvsr_alt(const Matrix_external SiRiS, const arrayxd_external sigma_beta, const arrayxd_external logodds, const arrayxd_external betahat, const arrayxd_external se, const arrayxd_external talpha0, const arrayxd_external tmu0, const arrayxd_external tSiRiSr0, const double tolerance, const int itermax, const int n, Rcpp::LogicalVector lnz_tol, const int grainsize);
RcppExport SEXP rssr_grid_search_rss_varbvsr_alt(SEXP SiRiSSEXP, SEXP sigma_betaSEXP, SEXP logoddsSEXP, SEXP betahatSEXP, SEXP seSEXP, SEXP talpha0SEXP, SEXP tmu0SEXP, SEXP tSiRiSr0SEXP, SEXP toleranceSEXP, SEXP itermaxSEXP, SEXP nSEXP, SEXP lnz_tolSEXP, SEXP grainsizeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Matrix_external >::type SiRiS(SiRiSSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(grid_search_rss_varbvsr_alt(SiRiS, sigma_beta, logodds, betahat, se, talpha0, tmu0, tSiRiSr0, tolerance, itermax, n, lnz_tol, grainsize));
    return rcpp_result_gen;
END_RCPP
}
