#' @param SiRiS a sparse matrix of class `dgCMatrix`, representing the LD matrix
#' @param sigma_beta a single value (numeric) specifying the value of the hyper-parameter sigma_beta 
