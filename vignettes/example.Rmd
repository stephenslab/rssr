...
If you do not run the `Matlab` script above to generate results from `rss_varbvsr.m`, please download the our result file [`example2_vb_results.mat`](https://uchicago.box.com/v/example2) to an directory (e.g. `/tmp`).

```{r}
m_results <- R.matlab::readMat("/tmp/example2_vb_results.mat")
